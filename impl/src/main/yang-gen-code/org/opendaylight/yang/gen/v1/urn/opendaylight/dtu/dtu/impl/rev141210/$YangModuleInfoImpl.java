...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "dtu-impl";
    private final String namespace = "urn:opendaylight:dtu:dtu-impl";
    private final String revision = "2014-12-10";
    private final String resourcePath = "/META-INF/yang/dtu-impl.yang";
