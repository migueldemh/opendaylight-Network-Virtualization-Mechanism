...
public abstract class AbstractDtuModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractDtuModule> implements org.opendaylight.yang.gen.v1.urn.opendaylight.dtu.dtu.impl.rev141210.DtuModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.opendaylight.yang.gen.v1.urn.opendaylight.dtu.dtu.impl.rev141210.AbstractDtuModule.class);
    ...
    public AbstractDtuModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractDtuModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractDtuModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractDtuModule oldModule){
    ...
    public boolean isSame(AbstractDtuModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractDtuModule that = (AbstractDtuModule) o;
